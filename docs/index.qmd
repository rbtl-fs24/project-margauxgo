...
In @fig-willingness, we observe that a majority of the population is willing to separate plastics at home before collection. Among those who are not willing, space constraints are the most commonly cited reason, while some did not provide a justification. Overall, space constraints are identified as the most significant barrier to separating plastics at home, followed by time constraints.
:::
# Conclusions
::: {.justify}
